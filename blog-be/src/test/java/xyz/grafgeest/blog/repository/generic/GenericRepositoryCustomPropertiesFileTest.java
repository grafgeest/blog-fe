...
import xyz.grafgeest.blog.config.H2JpaConfig;
...
@SpringBootTest(classes = {SpringBootRestApplication.class, H2JpaConfig.class})
public class GenericRepositoryCustomPropertiesFileTest {
